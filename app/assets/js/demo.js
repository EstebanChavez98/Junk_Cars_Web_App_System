...
demo = {
        ...
        function compras(){
            ...
            db.collection("purchases").onSnapshot((querySnapshot) => {
                querySnapshot.forEach((doc) => {
                    c += parseInt(doc.data().purchasePrice);
                });
            });
            return c;
        }
    ...
    showNotification: function(from, align) {
        ...
        $.notify({
            icon: "nc-icon nc-app",
            message: "Welcome to Zeus Management, The Web App where you can save, edit or consult any sale or purchase"
